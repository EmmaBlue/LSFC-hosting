    ...
    <div class="container" id="mainContent">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                ...
                <a href="page-book-visit.php?link=4" class="btn btn-default">BOOK A VISIT</a>
                <ul id="mainSoc">
                    <li class="socNavContain">
                        <a class="socNav" href="https://www.facebook.com/groups/LondonSFC/about/"><i class="fa fa-facebook"></i></a>
                        <a class="socNav" href="https://www.instagram.com/londonsquash/"><i class="fa fa-instagram"></i></a>
                        <a class="socNav" href="https://twitter.com/londonsquash"><i class="fa fa-twitter"></i></a>
                        <a class="socNav" href="https://www.linkedin.com/company/london-squash-&-fitness-club/"><i class="fa fa-linkedin"></i></a>
                    </li>
                </ul>
            </div>
        ...
        <div class="row">
              ...
              <h2><a href="# " class="title ">#1 PRIORITY: SQUASH</a></h2>
                <div class="service-block text-center" id="block1">
                  <div class="service-icon mb20">
                        <!-- service img -->
                        <img src="wp-content/themes/lsfc_working-final/images/squash-block.jpg" alt="Squash Players on the Court"> </div>
                    <!-- service img -->
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
              <h2><a href="#" class="title text-center ">TOP NOTCH FITNESS</a></h2>
                <div class="service-block text-center" id="block2">
                    ...
                    <div class="service-icon mb20">
                        <!-- service img -->
                        <img src="wp-content/themes/lsfc_working-final/images/gym.jpg" alt="Rackets in Shop"> </div>
                    <!-- service img -->
                    <div class="service-content">
                        <!-- service content -->
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                ...
                <div class="service-block text-center" id="block3">
                    ...
                    <div class="service-icon mb20">
                        <!-- service img -->
                        <img src="wp-content/themes/lsfc_working-final/images/players-small.jpg" alt="Players Smiling"> </div>
                    <!-- service img -->
            ...
            <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 text-center"> <a href="page-programs.php?link=3" class="btn btn-default"> SEE OUR PROGRAMS </a> </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <a href="page-book-visit.php?link=4" class="btn btn-default" target="_blank">book a time</a> </div>
        </div>
    </div>
</div>
...
<div class="cta-section" id="nashPage">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <img src="wp-content/themes/lsfc_working-final/images/nash-logo.svg" alt="Nash Cup Logo">
                <p class="cta-text bold">September 17-22 2018 </p>
                <p class="cta-text">We host the largest Professional Squash Association event in Canada. See Top 100 World players from all across the world.</p>
